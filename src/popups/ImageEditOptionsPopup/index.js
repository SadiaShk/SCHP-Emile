...
export default class ImageEditOptionsPopup extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            text: '',
            ...
            expiry: "",
            postOption: [
                { option: "Set as profile picture", image: icons.profilePic },
                { option: "Set as cover image", image: icons.galleryImageIcon },
                { option: "Delete", image: icons.trashIcon },
